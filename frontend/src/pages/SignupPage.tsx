      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
        ...
        >
          ...
          <h1 className="font-display text-5xl md:text-6xl font-bold tracking-tight mb-2">
            <span className="gradient-text">Join NEXUS</span>
          </h1>
          <p className="text-nexus-muted">Create an account to save your interview history</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-center text-sm text-nexus-muted pt-2">
            ...
            <Link to="/login" className="text-nexus-cyan hover:underline font-semibold">
              Sign in
            </Link>
          </p>
        </motion.form>
